...
export const useHotelsData = () => {
  ...
  useEffect(() => {
    // Simulating an API call or any asynchronous data fetching logic
    const fetchHotels = async () => {
      // Perform the necessary API call or fetch the hotel data from the desired source
      const hotelData = [
        {
          HotelID: 1,
          Name: "Presidio Hotel",
          ...
          PricePerNight: 3000,
          About:
            "Embark on a journey with your family and friends, away from the city into awe-inspiring naturescapes. Upon arriving at this villa, you will be swept away by the little bridge that traverses over a gentle stream, on a three-acre lush lawn. Spacious and welcoming with aesthetically pleasing interiors, all five bedrooms have ensuite bathrooms and are located on the ground level - a thoughtful plan to welcome our youngest and elderly guests.",
          Offer: 10,
          Site: "Beachside",
        },
        {
